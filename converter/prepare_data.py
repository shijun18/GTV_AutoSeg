...
if __name__ == "__main__":
    ...
    prepare_data(input_path, setting_2d['save_path'], tuple(setting_2d['shape']), setting_2d['crop'],mode='2d',retain=10)
    prepare_data(input_path, setting_2d['test_path'], tuple(setting_2d['shape']), setting_2d['crop'],mode='2d',for_training=False,retain=10)
    prepare_data(input_path, setting_3d['save_path'], tuple(setting_3d['shape']), setting_3d['crop'],mode='3d',retain=10)
